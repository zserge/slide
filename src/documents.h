...
class Page_b {
public:
  Page_b(const int w, const int h, cairo_surface_t *const psurf,
  ...
  virtual int text_width(const std::string &text, slide::Style style,
                         float scale) = 0;
  virtual void bg(const colour_t &color) = 0;
  virtual void text(const std::string &text, const colour_t &color, int x,
                    int y, slide::Style style, float scale) = 0;
...
public:
  Document_b(const int w, const int h, cairo_surface_t *const psurf,
             cairo_t *const pcr, const std::string &name);
...
public:
  ...
  void text(const std::string &text, const colour_t &color, int x, int y,
