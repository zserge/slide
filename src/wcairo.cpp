...
void wcairo::text(cairo_t *cr, const std::string &text, const colour_t &color,
...
void wcairo::show_page(cairo_t *cr) { cairo_show_page(cr); }
...
cairo_surface_t *wcairo::create_surface(int width, int height,
...
void wcairo::write_to_png_stream(cairo_surface_t *surface,
